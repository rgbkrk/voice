...
class TelegramVoiceContractVerifierTests(unittest.TestCase):
    def test_runs_voice_contract_and_hermes_config(self):
        ...
        self.assertIn("telegram_send_voice=compatible", result.stdout)
        self.assertIn("telegram_bot_voice_messages=compatible", result.stdout)
        self.assertIn("telegram_voice_calls=not_covered", result.stdout)
        self.assertIn("telegram_live_streaming=not_covered", result.stdout)
