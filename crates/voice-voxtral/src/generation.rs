...
pub struct VoxtralRuntimeLoadTrace {
    ...
    pub module_language_layers_load: Duration,
    pub module_language_norm_load: Duration,
    pub module_language_layer_count: usize,
...
impl VoxtralTtsRuntime {
    ...
    fn from_model_with_trace(
        ...
        let trace = VoxtralRuntimeLoadTrace {
            ...
            module_language_layers_load: module_trace.language_layers,
            module_language_norm_load: module_trace.language_norm,
            module_language_layer_count: module_trace.language_layer_count,
